...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <div class="row">
        <div class="col-md-3">
          <a href="compose_message.php" class="btn btn-primary btn-block mb-3">Compose Message</a>
          <div class="card">
            ...
            <div class="card-body p-0">
              <ul class="nav nav-pills flex-column">
                ...
                <li class="nav-item">
                  <a href="sent_messages.php" class="nav-link text-primary">
                      ...
                      if (mysqli_num_rows($messages) >=1) {
                        ...
                        while($mrow = mysqli_fetch_array($messages)){
                          ...
                          <tr>              
                            ...
                            <td class="mailbox-star"><a href="#"><i class="fas fa-right text-success"></i></a></td>
