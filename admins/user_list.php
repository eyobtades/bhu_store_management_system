      ...
      <nav class="ml-2 mr-2">
        <ul class="nav nav-pills  nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            <a href="manager_home.php" class="nav-link active">
          ...
          <li class="nav-item has-treeview" >
            ...
            <ul class="nav nav-treeview ml-4">
              <li class="nav-item">
                <a href="system_tools.php?act_id=provide" class="nav-link">
                  <p>Provide Materials</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="system_tools.php?act_id=return-back" class="nav-link">
                  <p>Return Materials</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="system_tools.php?act_id=manage" class="nav-link">
                  <p>Manage Users</p>
                </a>
              </li>
            </ul>
              ...
              echo ('
                  <tr>
                    ...
                    <td class="project-actions text-right">
                          ...
                          <a class="btn btn-danger btn-sm" href="?view_user.php?delid='.$row['user_id'].'">
